function feat = computefeature_gam(structdis,gam,r_gam)
...
[alpha, betal, betar]      = estimateaggdparam_gam(structdis(:),gam,r_gam);
...
[alpha, betal, betar]      = estimateaggdparam_gam(pair,gam,r_gam);
