function [objP,context,...
          bgP,final_overlap,binCode,points,bgTsh4,...
          CellSize,BlockSize,BlockOverlap,...
          Numbins,N_HOG] = FBTandMSTInit_regularBg(objbbox_0,frame_0,bg_overlap)
...
[objP_bin,~] = objPatchGen(objbbox_0,Nt+1,p,imSize);
...
Nbg = floor(N_HOG*0.9);
[bgP,final_overlap] = bgPatchGenReg(objbbox_0,context,Nbg,imSize,bg_overlap);
