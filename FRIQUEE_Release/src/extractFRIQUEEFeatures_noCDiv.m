...
function friqueeFeats = extractFRIQUEEFeatures_noCDiv(rgb)
...
%     friqueeFeats.friqueeALL = [fLuma fChroma fLMS fHueSatFeats cDivFeats];
    friqueeFeats.friqueeALL = [fLuma fChroma fLMS fHueSatFeats];
%     friqueeFeats.friqueeLuma = [fLuma fLumaCdiv'];
%     friqueeFeats.friqueeLuma = fLuma;
%     friqueeFeats.friqueeChroma = [fChroma fChromaCdiv'];
%     friqueeFeats.friqueeChroma = fChroma;
%     friqueeFeats.friqueeLMS = [fLMS fHueSatFeats  [fMCDiv' fSCDiv']];
%     friqueeFeats.friqueeLMS = [fLMS fHueSatFeats];
